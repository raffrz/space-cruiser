...
public class DoubleGun extends Gun {
    ...
    protected void shoot() {
        ...
        Bullet b1 = new Bullet(new Vector2f(this.user.position.x + 20, this.user.position.y + 4 + (int) (Math.random() * 32)), 1);
        Bullet b2 = new Bullet(new Vector2f(this.user.position.x + 12, this.user.position.y + 4 + (int) (Math.random() * 32)), 1);
